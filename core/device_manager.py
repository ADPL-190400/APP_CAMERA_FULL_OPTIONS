...
class DeviceManager(QObject):
    ...
    def _sync_running_pipeline(self, device_id: str) -> None:
        ...
        pipeline.update_ai_settings(
            ...
            occupancy_threshold=device.ai.occupancy_threshold,
            crowd_heatmap_threshold=device.ai.crowd_heatmap_threshold,
            ...
            stranger_repeat_mode=device.ai.stranger_repeat_mode,
